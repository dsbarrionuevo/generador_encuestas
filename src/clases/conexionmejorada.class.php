 ...
 *      ConexionMejorada::init('host', 'nombre_usuario', 'clave_usuario', 'base_datos');
 *      $conexion = ConexionMejorada::get_instacia();
...
class ConexionMejorada {
    ...
    /**
     * Devuele la única instancia actual de la clase ConexionMejorada. Para que 
     ...
     * 
     * @return ConexionMejorada Instancia única de ConexionMejorada.
     */
    public static function get_instacia() {
        ...
        if (is_null(self::$_instancia)) {
            self::$_instancia = new ConexionMejorada();
        }
     ...
     *      array(
     *          'campo' => 'apellido',
     *          'filtro' => ConexionMejorada::FILTRO_BUSQUEDA_COINCIDIR_STRING_DERECHO,
     *          'valor' => 'ez'
     *          ),
     *      array(
     *          'edad',
     *          ConexionMejorada::FILTRO_BUSQUEDA_MAYOR_QUE,
     *          20
     *          ),
     *      array(
     *          'edad',
     *          ConexionMejorada::FILTRO_BUSQUEDA_MENOR_QUE,
     *          36
     *          )
     *  );
